...
public class ContactMechanismTypeScreen extends ItemsListScreen<ContactMechanismType>
{
    ...
    {
        super(app, ContactMechanismType.class, 
                 new DetailsComponentSimple<ContactMechanismType>(app, new ContactMechanismTypeFormFieldFactory(app), VISIBLE_FIELDS), VISIBLE_COLUMNS);
    }
