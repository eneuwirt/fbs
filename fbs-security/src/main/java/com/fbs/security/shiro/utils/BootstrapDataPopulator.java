...
public class BootstrapDataPopulator implements InitializingBean
{
	...
	private static final String CREATE_TABLES = "create table users (\n"
	        ...
	        + ");\n"
	        + "CREATE TABLE tenants(id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, description VARCHAR(255));";
	...
	public void afterPropertiesSet() throws Exception
	{
		...
		query = "INSERT INTO tenants VALUES (null, 'Tenant 1')";
		jdbcTemplate.execute(query);
		log.log(Level.INFO, "Create tenant 1");
		
		query = "INSERT INTO tenants VALUES (null, 'Tenant 2')";
		jdbcTemplate.execute(query);
		log.log(Level.INFO, "Create tenant 2");
	}
}
