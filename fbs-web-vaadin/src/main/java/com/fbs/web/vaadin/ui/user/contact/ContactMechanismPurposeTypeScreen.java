...
public class ContactMechanismPurposeTypeScreen extends ItemsListScreen<ContactMechanismPurposeType>
{
    ...
    {
        super(app, ContactMechanismPurposeType.class, new DetailsComponentSimple<ContactMechanismPurposeType>(app,
                new ContactMechanismPurposeTypeFormFieldFactory(app), VISIBLE_FIELDS), VISIBLE_COLUMNS);
    }
