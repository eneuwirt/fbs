...
public class PartyRoleScreen extends ItemsListScreen<PartyRole>
{
    ...
    { PARTY_NAME, PARTY_ROLETYPE_DESCR };
    private static final String[] VISIBLE_COLUMNS = new String[]
    { ID, PARTY_NAME, PARTY_ROLETYPE_DESCR };
    private static final String[] VISIBLE_FIELDS = new String[]
    { ID, PARTY, PARTY_ROLETYPE };

    public PartyRoleScreen(MyVaadinApplication app)
    {
        super(app, PartyRole.class, new DetailsComponentSimple<PartyRole>(app, new PartyRoleFormFieldFactory(app), VISIBLE_FIELDS),
                VISIBLE_COLUMNS, NESTED_PROPERTIES);
    }
